...
template
class V8_EXPORT std::vector<v8::CpuProfileDeoptFrame>;
...
template
class V8_EXPORT std::vector<v8::CpuProfileDeoptInfo>;
...
// TickSample captures the information collected for each sample.
    struct TickSample {
        ...
        // samples don't care.
        enum RecordCEntryFrame {
            kIncludeCEntryFrame, kSkipCEntryFrame
        };
