...
namespace v8pp {
    ...
    namespace detail {
        ...
        public:
            ...
            using ctor_function = std::function<
            pointer_type (v8::FunctionCallbackInfo<v8::Value>
            const& args)>;
            using dtor_function =
...
/// Interface to access C++ classes bound to V8
    ...
    public:
        ...
        using ctor_function = std::function<
        object_pointer_type (v8::FunctionCallbackInfo<v8::Value>
        const& args)>;
        using dtor_function =
        std::function< void (v8::Isolate
        * isolate,
        object_pointer_type const &obj
        )>;
            ...
            class_info_.js_function_template()->GetFunction(isolate()->GetCurrentContext()).ToLocalChecked()
                    ->DefineOwnProperty(isolate()->GetCurrentContext(),
                                        ...
                                        v8::PropertyAttribute(
                                                v8::DontDelete | (readonly ? v8::ReadOnly : 0))).FromJust();
            return *this;
        }
