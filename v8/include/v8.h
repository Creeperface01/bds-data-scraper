 ...
 */
   ...
   */
    ...
    private:
        ...
        template<class F> friend
        class Eternal;

        template<class F> friend
        class PersistentBase;

        template<class F, class M> friend
        class Persistent;
        ...
        template<class F1, class F2> friend
        class PersistentValueVector;
...
// possible to request a second pass callback.
    enum class WeakCallbackType {
        kParameter, kInternalFields, kFinalizer
    };
 ...
 */
   ...
   */
        V8_DEPRECATE_SOON("Use TracedGlobal.", V8_INLINE
                void MarkActive());

        V8_DEPRECATED("See MarkIndependent.", V8_INLINE
 ...
 */
    ...
    public:
        enum Type {
            kRunMicrotasks, kDoNotRunMicrotasks
        };
 ...
 */
   ...
   */
    ...
    private:
        ...
        template<class T, class M> friend
        class Persistent;
